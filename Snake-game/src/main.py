...
def pause():
    ...
    while paused:
        ...
        message_to_screen(f'HIGH SCORE: {highScore}')
...
def shortcuts():
    ...
    while welcome_screen:
        ...
        message_to_screen(f"HIGH SCORE: {score}")
...
def intro():
    ...
    while intro:
        ...
        message_to_screen(f"HIGH SCORE: {high_score}", black, 50, 's')
        pygame.display.update()
...
def game_loop():
    ...
    while not gameExit:
        if gameOver:
            ...
            message_to_screen(f"HIGH SCORE: {highScore}", black, 50, 's' )
